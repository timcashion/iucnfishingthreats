...
```{r raw-data}
sau_profit <- read_csv(file.path(dir_data, "allocated_super_gear_profit.csv"))
```
...
for(gear in gear_types){
  ...
  write_csv(threat_dat, file.path(dir_output, paste(gear, "_SAU_IUCN_threat_", cell_size, ".csv", sep="")))
}
