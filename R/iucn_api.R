...
# Token: 82651e07b102744bd1077c6b474bf76737099e5658071ee895778ea6d18fa454 (Authorized to Tim Cashion, trcashion@gmail.com)
...
ipak(c("jsonlite", "RPushbullet"))

my_token <- "82651e07b102744bd1077c6b474bf76737099e5658071ee895778ea6d18fa454" #Need to remove this from all previous versions as well. 
...
if(reload==FALSE){
  species_threats <- read.csv("./data/species_threats.csv", stringsAsFactors = FALSE) %>% mutate(id=as.character(id))
